...
use Kwai\Modules\Trainings\Infrastructure\Repositories\TrainingDefinitionDatabaseRepository;
use Tests\Context;

$context = Context::createContext();

it('can get a training definition', function () use ($context) {
    $repo = new TrainingDefinitionDatabaseRepository($context->db);
    try {
        ...
        expect($definition->domain())
            ->toBeInstanceOf(TrainingDefinition::class)
        ;
